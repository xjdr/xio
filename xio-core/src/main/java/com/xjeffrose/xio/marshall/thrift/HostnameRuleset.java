...
public class HostnameRuleset
    implements org.apache.thrift.TBase<HostnameRuleset, HostnameRuleset._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<HostnameRuleset> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("HostnameRuleset");

  private static final org.apache.thrift.protocol.TField BLACKLIST_HOSTS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "blacklistHosts", org.apache.thrift.protocol.TType.SET, (short) 1);
  private static final org.apache.thrift.protocol.TField WHITELIST_HOSTS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "whitelistHosts", org.apache.thrift.protocol.TType.SET, (short) 2);
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        HostnameRuleset.class, metaDataMap);
  }

  public HostnameRuleset() {}

  public HostnameRuleset(Set<String> blacklistHosts, Set<String> whitelistHosts) {
    this();
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof HostnameRuleset) return this.equals((HostnameRuleset) that);
    return false;
  }
  ...
  public boolean equals(HostnameRuleset that) {
    ...
    if (this_present_blacklistHosts || that_present_blacklistHosts) {
      if (!(this_present_blacklistHosts && that_present_blacklistHosts)) return false;
      if (!this.blacklistHosts.equals(that.blacklistHosts)) return false;
    }
    ...
    if (this_present_whitelistHosts || that_present_whitelistHosts) {
      if (!(this_present_whitelistHosts && that_present_whitelistHosts)) return false;
      if (!this.whitelistHosts.equals(that.whitelistHosts)) return false;
    }
  ...
  public int hashCode() {
    ...
    if (present_blacklistHosts) list.add(blacklistHosts);

    boolean present_whitelistHosts = true && (isSetWhitelistHosts());
    list.add(present_whitelistHosts);
    if (present_whitelistHosts) list.add(whitelistHosts);
  ...
  public int compareTo(HostnameRuleset other) {
    ...
    if (isSetBlacklistHosts()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.blacklistHosts, other.blacklistHosts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetWhitelistHosts()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.whitelistHosts, other.whitelistHosts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (blacklistHosts == null) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'blacklistHosts' was not present! Struct: " + toString());
    }
    if (whitelistHosts == null) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'whitelistHosts' was not present! Struct: " + toString());
    }
  ...
  private static class HostnameRulesetStandardScheme extends StandardScheme<HostnameRuleset> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HostnameRuleset struct)
        throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HostnameRuleset struct)
        throws org.apache.thrift.TException {
      struct.validate();
        ...
        oprot.writeFieldBegin(BLACKLIST_HOSTS_FIELD_DESC);
        {
          oprot.writeSetBegin(
              new org.apache.thrift.protocol.TSet(
                  org.apache.thrift.protocol.TType.STRING, struct.blacklistHosts.size()));
      ...
      if (struct.whitelistHosts != null) {
        oprot.writeFieldBegin(WHITELIST_HOSTS_FIELD_DESC);
        {
          oprot.writeSetBegin(
              new org.apache.thrift.protocol.TSet(
                  org.apache.thrift.protocol.TType.STRING, struct.whitelistHosts.size()));
  ...
  private static class HostnameRulesetTupleScheme extends TupleScheme<HostnameRuleset> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HostnameRuleset struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HostnameRuleset struct)
        throws org.apache.thrift.TException {
