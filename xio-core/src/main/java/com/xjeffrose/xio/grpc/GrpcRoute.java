...
public class GrpcRoute {
   ...
   * @param methodName the name of the gRPC method. Found in the `.proto` file, in the service definition, after the `rpc` keyword.
   * @param handler a subclass of GrpcRequestHandler that is specified for a specific Request and Response types and has the business logic for the route.
   * */
