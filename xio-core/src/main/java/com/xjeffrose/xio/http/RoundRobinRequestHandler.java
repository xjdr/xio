...
/**
 * This uses round robin strategy to delegate request handling to another set of one or more request
 * handlers. Currently this is performing the load balancing but should probably merged/reworked
 * with client distributor functionality.
 */
public class RoundRobinRequestHandler implements RequestHandler {
  @Getter private final ImmutableList<RequestHandler> handlers;
