...
public class GrpcRouteStateBuilderTest extends Assert {
  ...
  public void testGrpcRoute() {
    ...
    List<RouteState> routeStates =
        subject.buildGrpcRouteStates(Collections.singletonList(grpcService));
  ...
  public void testBuildingAllRoutes() {
    ...
    List<RouteState> routeStates =
        subject.buildGrpcRouteStates(Arrays.asList(grpcService1, grpcService2));
  ...
  private class TestGrpcService implements GrpcService {
    ...
    List<GrpcRoute> routes =
        Collections.singletonList(
            new GrpcRoute(this, "method_name", new GrpcRequestHandler<>(null, null)));
