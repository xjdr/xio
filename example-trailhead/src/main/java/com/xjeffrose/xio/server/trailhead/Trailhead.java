...
import com.xjeffrose.xio.http.Http1ProxyFragment;
...
public class Trailhead implements AutoCloseable {
  ...
  private RouteProvider buildProvider(Route route, ProxyConfig proxyConfig) {
    return new SimpleProxyRoute(route, proxyConfig);
  }
