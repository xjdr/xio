...
public class DefaultChannelInitializer extends ChannelInitializer {
  ...
  public DefaultChannelInitializer(ChannelHandler handler, SslContext sslContext, Supplier<ChannelHandler> applicationProtocol, Supplier<ChannelHandler> tracingHandler) {
  ...
  public void initChannel(Channel channel) {
    ...
    if (sslContext != null) {
      cp.addLast("encryptionHandler", sslContext.newHandler(channel.alloc()));
    }
