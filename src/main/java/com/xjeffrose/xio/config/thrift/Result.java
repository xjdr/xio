...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  private static final org.apache.thrift.protocol.TField ERROR_REASON_FIELD_DESC = new org.apache.thrift.protocol.TField("errorReason", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  static {
    ...
    tmpMap.put(_Fields.ERROR_REASON, new org.apache.thrift.meta_data.FieldMetaData("errorReason", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public boolean equals(Result that) {
    ...
    if (this_present_errorReason || that_present_errorReason) {
      if (!(this_present_errorReason && that_present_errorReason))
        return false;
      if (!this.errorReason.equals(that.errorReason))
        return false;
    }
