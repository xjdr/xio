...
public class Http1Ruleset
    implements org.apache.thrift.TBase<Http1Ruleset, Http1Ruleset._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<Http1Ruleset> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("Http1Ruleset");

  private static final org.apache.thrift.protocol.TField BLACKLIST_RULES_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "blacklistRules", org.apache.thrift.protocol.TType.SET, (short) 1);
  private static final org.apache.thrift.protocol.TField WHITELIST_RULES_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "whitelistRules", org.apache.thrift.protocol.TType.SET, (short) 2);
        ...
        new org.apache.thrift.meta_data.FieldMetaData(
            ...
            new org.apache.thrift.meta_data.SetMetaData(
                ...
                new org.apache.thrift.meta_data.StructMetaData(
                    org.apache.thrift.protocol.TType.STRUCT, Http1Rule.class))));
    tmpMap.put(
        _Fields.WHITELIST_RULES,
        new org.apache.thrift.meta_data.FieldMetaData(
            "whitelistRules",
            org.apache.thrift.TFieldRequirementType.REQUIRED,
            new org.apache.thrift.meta_data.SetMetaData(
  ...
  public Http1Ruleset(Set<Http1Rule> blacklistRules, Set<Http1Rule> whitelistRules) {
    this();
  ...
  public boolean equals(Object that) {
    ...
    if (that instanceof Http1Ruleset) return this.equals((Http1Ruleset) that);
    return false;
  }
  ...
  public boolean equals(Http1Ruleset that) {
    ...
    if (this_present_blacklistRules || that_present_blacklistRules) {
      if (!(this_present_blacklistRules && that_present_blacklistRules)) return false;
      if (!this.blacklistRules.equals(that.blacklistRules)) return false;
    }
    ...
    if (this_present_whitelistRules || that_present_whitelistRules) {
      if (!(this_present_whitelistRules && that_present_whitelistRules)) return false;
      if (!this.whitelistRules.equals(that.whitelistRules)) return false;
    }
  ...
  public int hashCode() {
    ...
    if (present_blacklistRules) list.add(blacklistRules);

    boolean present_whitelistRules = true && (isSetWhitelistRules());
    list.add(present_whitelistRules);
    if (present_whitelistRules) list.add(whitelistRules);
  ...
  public int compareTo(Http1Ruleset other) {
    ...
    if (isSetBlacklistRules()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.blacklistRules, other.blacklistRules);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetWhitelistRules()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.whitelistRules, other.whitelistRules);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (blacklistRules == null) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'blacklistRules' was not present! Struct: " + toString());
    }
    if (whitelistRules == null) {
      throw new org.apache.thrift.protocol.TProtocolException(
          "Required field 'whitelistRules' was not present! Struct: " + toString());
    }
  ...
  private static class Http1RulesetStandardScheme extends StandardScheme<Http1Ruleset> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Http1Ruleset struct)
        throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Http1Ruleset struct)
        throws org.apache.thrift.TException {
      struct.validate();
        ...
        oprot.writeFieldBegin(BLACKLIST_RULES_FIELD_DESC);
        {
          oprot.writeSetBegin(
              new org.apache.thrift.protocol.TSet(
                  org.apache.thrift.protocol.TType.STRUCT, struct.blacklistRules.size()));
      ...
      if (struct.whitelistRules != null) {
        oprot.writeFieldBegin(WHITELIST_RULES_FIELD_DESC);
        {
          oprot.writeSetBegin(
              new org.apache.thrift.protocol.TSet(
                  org.apache.thrift.protocol.TType.STRUCT, struct.whitelistRules.size()));
  ...
  private static class Http1RulesetTupleScheme extends TupleScheme<Http1Ruleset> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Http1Ruleset struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Http1Ruleset struct)
        throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        org.apache.thrift.protocol.TSet _set18 =
            new org.apache.thrift.protocol.TSet(
      ...
      struct.setBlacklistRulesIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set21 =
            new org.apache.thrift.protocol.TSet(
                org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
