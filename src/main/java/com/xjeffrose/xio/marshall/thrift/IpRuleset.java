...
public class IpRuleset implements org.apache.thrift.TBase<IpRuleset, IpRuleset._Fields>, java.io.Serializable, Cloneable, Comparable<IpRuleset> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IpRuleset");

  private static final org.apache.thrift.protocol.TField BLACKLIST_IPS_FIELD_DESC = new org.apache.thrift.protocol.TField("blacklistIps", org.apache.thrift.protocol.TType.SET, (short)1);
  private static final org.apache.thrift.protocol.TField WHITELIST_IPS_FIELD_DESC = new org.apache.thrift.protocol.TField("whitelistIps", org.apache.thrift.protocol.TType.SET, (short)2);
  ...
  static {
    ...
    tmpMap.put(_Fields.BLACKLIST_IPS, new org.apache.thrift.meta_data.FieldMetaData("blacklistIps", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.SetMetaData(org.apache.thrift.protocol.TType.SET, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , true))));
    tmpMap.put(_Fields.WHITELIST_IPS, new org.apache.thrift.meta_data.FieldMetaData("whitelistIps", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.SetMetaData(org.apache.thrift.protocol.TType.SET, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , true))));
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IpRuleset)
      return this.equals((IpRuleset)that);
    return false;
  }
  ...
  public boolean equals(IpRuleset that) {
    ...
    if (this_present_blacklistIps || that_present_blacklistIps) {
      if (!(this_present_blacklistIps && that_present_blacklistIps))
        return false;
      if (!this.blacklistIps.equals(that.blacklistIps))
        return false;
    }
    ...
    if (this_present_whitelistIps || that_present_whitelistIps) {
      if (!(this_present_whitelistIps && that_present_whitelistIps))
        return false;
      if (!this.whitelistIps.equals(that.whitelistIps))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (present_blacklistIps)
      list.add(blacklistIps);

    boolean present_whitelistIps = true && (isSetWhitelistIps());
    list.add(present_whitelistIps);
    if (present_whitelistIps)
      list.add(whitelistIps);
  ...
  public int compareTo(IpRuleset other) {
    ...
    if (isSetBlacklistIps()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blacklistIps, other.blacklistIps);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetWhitelistIps()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.whitelistIps, other.whitelistIps);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (blacklistIps == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'blacklistIps' was not present! Struct: " + toString());
    }
    if (whitelistIps == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'whitelistIps' was not present! Struct: " + toString());
    }
  ...
  private static class IpRulesetStandardScheme extends StandardScheme<IpRuleset> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, IpRuleset struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IpRuleset struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.blacklistIps != null) {
        ...
        {
          oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.blacklistIps.size()));
      ...
      if (struct.whitelistIps != null) {
        ...
        {
          oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.whitelistIps.size()));
  ...
  private static class IpRulesetTupleScheme extends TupleScheme<IpRuleset> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IpRuleset struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IpRuleset struct) throws org.apache.thrift.TException {
