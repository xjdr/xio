...
public class KeyStoreFactoryTest {
    ...
    KeyStore ks =
        ks =
            KeyStoreFactory.Generate(
                SelfSignedX509CertGenerator.generate("example.com"), "selfsignedcert");
  ...
  public void testGenerateRealCerts() throws Exception {
    KeyStore ks =
        KeyStoreFactory.Generate(
            X509CertificateGenerator.generate(
                "src/test/resources/privateKey.pem", "src/test/resources/cert.pem"),
            "my_really-AWESOME_P@ss");
